...
### 1. We Forked Reverie Theme into this Repository
...
To use it, we forked this repository, then rename the repository to `ms-devops-fr.github.io`.

Alternatively, we could have clicked the [`Use this template`](https://github.com/amitmerchant1990/reverie/generate) button if you want to create a repository with a clean commit history which will use Reverie as a template.

This Jekyll blog is viewable immediately at <https://ms-devops-fr.github.io>.

### 2. Customize and view your site

We customized it by following this procedure : 

Enter your site name, description, avatar and many other options by editing the `_config.yml` file. You can easily turn on Google Analytics tracking, Disqus commenting and social icons here.

Making a change to `_config.yml` (or any file in your repository) will force GitHub Pages to rebuild your site with Jekyll. Your rebuilt site will be viewable a few seconds later at <https://yourgithubusername.github.io> - if not, give it ten minutes as GitHub suggests and it'll appear soon.

### 3. Publish your additional blog post
...
## Using Categories in Reverie Theme
